...
class Pokemon_moves{
	private:
		...
		int order_;
	public:
		Pokemon_moves(int pokemon_id, int version_group_id, int move_id, int pokemon_move_method_id, int level, int order) : pokemon_id_(pokemon_id), version_group_id_(version_group_id), move_id_(move_id), pokemon_move_method_id_(pokemon_move_method_id), level_(level), order_(order){}
...
class Type_names{
	private:
		...
		std::string name_;
	public:
		Type_names(int type_id, int local_language_id, std::string name) : type_id_(type_id), local_language_id_(local_language_id), name_(name){}
		int type_id() const {return type_id_;}
...
class Pokemon_stats{
	private:
		...
		int effort_;
	public:
		Pokemon_stats(int pokemon_id, int stat_id, int base_stat, int effort) : pokemon_id_(pokemon_id), stat_id_(stat_id), base_stat_(base_stat), effort_(effort){}
		int pokemon_id() const {return pokemon_id_;}
...
class Stats{
	private:
		...
		int game_index_;
	public:
		Stats(int id, int damage_class_id, std::string identifier, int is_battle_only, int game_index) : id_(id), damage_class_id_(damage_class_id), identifier_(identifier), is_battle_only_(is_battle_only), game_index_(game_index){}
		int id() const {return id_;}
		int damage_class_id() const {return damage_class_id_;}
		std::string identifier() const {return identifier_;}
...
class Pokemon_types{
	private:
		...
		int slot_;
	public:
		Pokemon_types(int pokemon_id, int type_id, int slot) : pokemon_id_(pokemon_id), type_id_(type_id), slot_(slot){}
		int pokemon_id() const {return pokemon_id_;}
		int type_id() const {return type_id_;}
